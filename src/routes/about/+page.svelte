...
<div class="mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 py-8 md:py-12">
  <!-- Disclaimer -->
  <section class="rounded-2xl border border-amber-500/20 bg-amber-500/10 p-5 shadow-sm">
    <p class="text-sm font-semibold text-amber-700 dark:text-amber-200 flex items-center gap-2">
      <Lock class="h-4 w-4" />
      Disclaimer
    </p>
    <p class="mt-2 text-sm leading-relaxed text-amber-700/80 dark:text-amber-200/80">
  ...
  >
    <div class="flex flex-col gap-6 md:flex-row md:items-start md:justify-between">
      <div class="space-y-4 md:max-w-2xl">
        ...
        <h1 class="text-3xl font-semibold text-foreground dark:text-white md:text-4xl">About Entra Token Studio</h1>
        <p class="text-base leading-relaxed text-muted-foreground dark:text-slate-200">
        ...
        <div class="flex flex-wrap gap-2 pt-2">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            class="inline-flex items-center gap-2 rounded-lg border border-transparent bg-primary px-4 py-2 text-sm font-semibold text-primary-foreground shadow-sm ring-1 ring-primary/30 transition hover:bg-primary/90 hover:ring-primary/40 dark:border-transparent dark:bg-white/10 dark:text-white dark:ring-white/20 dark:hover:bg-white/15 dark:hover:ring-white/30"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            class="inline-flex items-center gap-2 rounded-lg border border-border bg-background px-4 py-2 text-sm font-semibold text-foreground shadow-sm transition hover:bg-accent hover:text-accent-foreground dark:border-white/20 dark:bg-white/5 dark:text-slate-100 dark:hover:border-white/40 dark:hover:bg-white/10"
          >
            Report an issue
          </a>
        </div>
      </div>
      <div class="rounded-2xl border border-border/80 bg-white/80 px-5 py-4 text-sm text-muted-foreground shadow-lg backdrop-blur dark:border-white/10 dark:bg-white/5 dark:text-slate-100 md:min-w-[200px]">
        <p class="font-semibold text-foreground dark:text-white flex items-center gap-2">
          <Lock class="h-4 w-4 text-primary dark:text-primary" />
          Core Principles
        </p>
        <ul class="mt-3 space-y-2 text-muted-foreground dark:text-slate-200">
          <li class="flex items-center gap-2 text-foreground dark:text-slate-100">
    ...
    <div class="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
      ...
      <div class="group rounded-2xl border border-primary/10 bg-card/70 p-5 shadow-sm transition hover:border-primary/20 hover:shadow-md">
        <div class="flex items-center gap-3">
          <div class="rounded-lg bg-amber-500/10 p-2 ring-1 ring-amber-500/20">
            <KeyRound class="h-5 w-5 text-amber-600 dark:text-amber-400" />
          </div>
      ...
      <div class="group rounded-2xl border border-primary/10 bg-card/70 p-5 shadow-sm transition hover:border-primary/20 hover:shadow-md">
        <div class="flex items-center gap-3">
          ...
          <h3 class="font-semibold text-foreground">Token Inspection</h3>
        </div>
        <p class="mt-3 text-sm text-muted-foreground">
  ...
  <section class="rounded-3xl border border-border bg-card/70 p-6 shadow-sm">
    ...
    <div class="grid gap-4 md:grid-cols-3">
      ...
      <div class="rounded-2xl border border-amber-500/20 bg-amber-500/10 p-5">
        ...
        <ul class="space-y-2 text-sm text-muted-foreground">
          <li class="flex items-center gap-2">
            <ShieldHalf class="h-3.5 w-3.5 text-amber-600 dark:text-amber-400" />
            App token issuance
          </li>
          <li class="flex items-center gap-2">
            <KeyRound class="h-3.5 w-3.5 text-amber-600 dark:text-amber-400" />
        ...
        <p class="mt-3 text-xs text-amber-600/80 dark:text-amber-400/80">Runs locally. No external hosting.</p>
      </div>
