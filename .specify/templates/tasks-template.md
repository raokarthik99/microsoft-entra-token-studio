...
- Include tasks for `pnpm check`, `pnpm build`, and manual smoke coverage of app/user token flows, decoded claims filters, history load/reissue/delete, favorites CRUD/bulk delete, fullscreen token view, and settings export/import (replace).
